 ...
 * Command line was: qdbusxml2cpp -c NMDevice -p NMDevice -N -i NetworkManagerConnection.h nm-device.xml
 *
...
#ifndef NMDEVICE_H_1353213530
#define NMDEVICE_H_1353213530
 ...
 */
class NMDevice: public QDBusAbstractInterface
{
    Q_OBJECT
public:
...
public:
    NMDevice(const QString &service, const QString &path, const QDBusConnection &connection, QObject *parent = 0);
