 ...
 * Command line was: qdbusxml2cpp -c NMSettingsConnection -p NMSettingsConnection -N nm-settings-connection.xml
 *
...
#ifndef NMSETTINGSCONNECTION_H_1353210472
#define NMSETTINGSCONNECTION_H_1353210472
...
public Q_SLOTS: // METHODS
    ...
    inline QDBusPendingReply<QVariantMap> GetSecrets(const QString &setting_name)
    {
        QList<QVariant> argumentList;
    ...
    inline QDBusPendingReply<> Update(const QVariantMap &properties)
    {
        QList<QVariant> argumentList;
