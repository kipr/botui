 ...
 * Command line was: qdbusxml2cpp -c NMNetworkManager -p NMNetworkManager nm-manager.xml
 *
...
#ifndef NMNETWORKMANAGER_H_1353208484
#define NMNETWORKMANAGER_H_1353208484
 ...
 */
class NMNetworkManager: public QDBusAbstractInterface
{
    Q_OBJECT
public:
...
public:
    NMNetworkManager(const QString &service, const QString &path, const QDBusConnection &connection, QObject *parent = 0);
...
public Q_SLOTS: // METHODS
    ...
    inline QDBusPendingReply<QDBusObjectPath, QDBusObjectPath> AddAndActivateConnection(const QVariantMap &connection, const QDBusObjectPath &device, const QDBusObjectPath &specific_object)
    {
        QList<QVariant> argumentList;
        argumentList << qVariantFromValue(connection) << qVariantFromValue(device) << qVariantFromValue(specific_object);
        return asyncCallWithArgumentList(QLatin1String("AddAndActivateConnection"), argumentList);
    }
    inline QDBusReply<QDBusObjectPath> AddAndActivateConnection(const QVariantMap &connection, const QDBusObjectPath &device, const QDBusObjectPath &specific_object, QDBusObjectPath &active_connection)
    {
        QList<QVariant> argumentList;
        argumentList << qVariantFromValue(connection) << qVariantFromValue(device) << qVariantFromValue(specific_object);
    ...
    inline QDBusPendingReply<QVariantMap> GetPermissions()
    {
        QList<QVariant> argumentList;
...
namespace org {
  namespace freedesktop {
    typedef ::NMNetworkManager NetworkManager;
  }
}
#endif
