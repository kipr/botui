...
Wombat::SettingsProvider::~SettingsProvider() { sync(); }

void Wombat::SettingsProvider::setValue(const QString &key,
                                        const QVariant &value) {
    m_settings[key] = value;
}

QVariant Wombat::SettingsProvider::value(const QString &key,
                                         const QVariant &_default) const {
