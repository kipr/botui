#ifndef _FILEACTIONCOMPILESINGLE_H_
#define _FILEACTIONCOMPILESINGLE_H_
...
class FileActionCompileSingle : public QObject, public FileActionExtension {
    Q_OBJECT
  public:
    FileActionCompileSingle();
